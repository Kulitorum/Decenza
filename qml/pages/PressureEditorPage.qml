...
/**
 * PressureEditorPage - Simple pressure profile editor (settings_2a)
 *
 * Matches de1app's settings_2a editor layout:
 * Profile Temp → 1: Preinfuse → 2: Rise and Hold → 3: Decline → 4: Stop at Weight
 */
Page {
    id: pressureEditorPage
    objectName: "pressureEditorPage"
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Text {
                text: TranslationManager.translate("pressureEditor.title", "Pressure Profile Editor")
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    ProfileGraph {
                        ...
                        frames: []
                        selectedFrameIndex: pressureEditorPage.selectedFrameIndex

                        onFrameSelected: function(index) {
                            pressureEditorPage.selectedFrameIndex = index
                ...
                Item {
                    ...
                    Text {
                        id: pressureDescLabel
                        anchors.top: parent.top
                        anchors.left: parent.left
                        anchors.leftMargin: Theme.scaled(4)
                        text: TranslationManager.translate("pressureEditor.descriptionLabel", "Description")
                        font: Theme.captionFont
                        color: Theme.textSecondaryColor
                    }

                    Rectangle {
                        anchors.top: pressureDescLabel.bottom
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    text: TranslationManager.translate("pressureEditor.profileTemp", "Profile temp")
                                ...
                                Rectangle {
                                    ...
                                    Text {
                                        ...
                                        text: TranslationManager.translate("pressureEditor.tempSteps", "Steps")
                                        font.family: Theme.captionFont.family
                                        font.pixelSize: Theme.captionFont.pixelSize
                                        color: Theme.temperatureColor
                                    }
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text { text: TranslationManager.translate("pressureEditor.preinfuse", "Preinfuse"); font.family: Theme.bodyFont.family; font.pixelSize: Theme.bodyFont.pixelSize; font.bold: true; color: Theme.textColor }
                                    Item { Layout.fillWidth: true }
                                    Rectangle {
                                ...
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.time", "Time"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                                ...
                                // Flow rate
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.flowRate", "Flow rate"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                                ...
                                // Pressure
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.pressure", "Pressure"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text { text: TranslationManager.translate("pressureEditor.riseAndHold", "Rise and Hold"); font.family: Theme.bodyFont.family; font.pixelSize: Theme.bodyFont.pixelSize; font.bold: true; color: Theme.textColor }
                                    Item { Layout.fillWidth: true }
                                    Rectangle {
                                ...
                                // Time
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.holdTime", "Time"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                                ...
                                // Limit flow
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.limitFlow", "Limit flow"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text { text: TranslationManager.translate("pressureEditor.decline", "Decline"); font.family: Theme.bodyFont.family; font.pixelSize: Theme.bodyFont.pixelSize; font.bold: true; color: Theme.textColor }
                                    Item { Layout.fillWidth: true }
                                    Rectangle {
                                ...
                                // Time
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.declineTime", "Time"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text { text: TranslationManager.translate("pressureEditor.stopAtWeight", "Stop at Weight"); font.family: Theme.bodyFont.family; font.pixelSize: Theme.bodyFont.pixelSize; font.bold: true; color: Theme.textColor }
                                }

                                // Dose
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.dose", "Dose"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                                ...
                                // Weight
                                RowLayout { Layout.fillWidth: true
                                    Text { text: TranslationManager.translate("pressureEditor.weight", "Weight"); font: Theme.captionFont; color: Theme.textSecondaryColor }
                                    Item { Layout.fillWidth: true }
                                ...
                                Text {
                                    Layout.fillWidth: true
                                    text: TranslationManager.translate("pressureEditor.ratio", "Ratio: 1:") + ((recipe.targetWeight || 36) / (recipe.dose || 18)).toFixed(1)
                                    font: Theme.captionFont
                                    color: Theme.textSecondaryColor
    ...
    BottomBar {
        id: bottomBar
        title: MainController.currentProfileName || TranslationManager.translate("pressureEditor.pressure", "Pressure")
        onBackClicked: {
            if (recipeModified) {
                exitDialog.open()
            } else {
        ...
        Text {
            text: MainController.frameCount() + " " + TranslationManager.translate("pressureEditor.frames", "frames")
            color: "white"
            font: Theme.bodyFont
        }
        ...
        AccessibleButton {
            text: TranslationManager.translate("pressureEditor.done", "Done")
            accessibleName: TranslationManager.translate("pressureEditor.finishEditing", "Finish editing pressure profile")
            onClicked: {
                if (recipeModified) {
                    exitDialog.open()
                } else {
            ...
            background: Rectangle {
                implicitWidth: Math.max(Theme.scaled(80), pressureDoneText.implicitWidth + Theme.scaled(32))
        ...
        contentItem: ColumnLayout {
            ...
            Item {
                ...
                Text {
                    ...
                    text: TranslationManager.translate("pressureEditor.tempStepsTitle", "Temperature Steps")
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: TranslationManager.translate("pressureEditor.start", "Start"); font: Theme.bodyFont; color: Theme.textColor }
                        Item { Layout.fillWidth: true }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: "1: " + TranslationManager.translate("pressureEditor.preinfuse", "Preinfuse"); font: Theme.bodyFont; color: Theme.textColor }
                        Item { Layout.fillWidth: true }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: "2: " + TranslationManager.translate("pressureEditor.riseAndHold", "Rise and Hold"); font: Theme.bodyFont; color: Theme.textColor }
                        Item { Layout.fillWidth: true }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: "3: " + TranslationManager.translate("pressureEditor.decline", "Decline"); font: Theme.bodyFont; color: Theme.textColor }
                        Item { Layout.fillWidth: true }
        ...
        contentItem: ColumnLayout {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.leftMargin: Theme.scaled(20)
                    anchors.verticalCenter: parent.verticalCenter
                    text: TranslationManager.translate("pressureEditor.saveError", "Save Failed")
                    font: Theme.titleFont
                    color: Theme.textColor
                }
            ...
            Text {
                text: TranslationManager.translate("pressureEditor.saveErrorMessage", "Could not save the profile. Please try again or use Save As with a different name.")
                font: Theme.bodyFont
                color: Theme.textColor
                wrapMode: Text.Wrap
                Layout.fillWidth: true
    ...
    Dialog {
        ...
        contentItem: ColumnLayout {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.leftMargin: Theme.scaled(20)
                    anchors.verticalCenter: parent.verticalCenter
                    text: TranslationManager.translate("pressureEditor.saveAs", "Save Profile As")
                    font: Theme.titleFont
                    color: Theme.textColor
                }
            ...
            ColumnLayout {
                ...
                Text {
                    text: TranslationManager.translate("pressureEditor.profileTitle", "Profile Title")
                    font: Theme.captionFont
                    color: Theme.textSecondaryColor
                }
                ...
                TextField {
                    ...
                    font: Theme.bodyFont
                    color: Theme.textColor
                    placeholderText: TranslationManager.translate("pressureEditor.namePlaceholder", "Enter profile name")
        ...
        onOpened: {
            saveAsTitleField.text = MainController.currentProfileName || "New Pressure Profile"
        ...
        contentItem: ColumnLayout {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.leftMargin: Theme.scaled(20)
                    anchors.verticalCenter: parent.verticalCenter
                    text: TranslationManager.translate("pressureEditor.profileExists", "Profile Exists")
                    font: Theme.titleFont
                    color: Theme.textColor
                }
            ...
            Text {
                text: TranslationManager.translate("pressureEditor.overwriteConfirm", "A profile with this name already exists.\nDo you want to overwrite it?")
                font: Theme.bodyFont
                color: Theme.textColor
                wrapMode: Text.Wrap
                Layout.fillWidth: true
    ...
    StackView.onActivated: {
        ...
        if (!MainController.isCurrentProfileRecipe) {
            MainController.createNewPressureProfile(MainController.currentProfileName || "New Pressure Profile")
        }
        loadCurrentProfile()
        root.currentPageTitle = MainController.currentProfileName || TranslationManager.translate("pressureEditor.title", "Pressure Profile Editor")

...
ApplicationWindow {
    ...
    Component.onCompleted: {
        ...
        if (AppInfo.previousCrashLog && AppInfo.previousCrashLog.length > 0) {
    ...
    CrashReportDialog {
        ...
        crashLog: AppInfo.previousCrashLog || ""
        debugLogTail: AppInfo.previousDebugLogTail || ""
    ...
    Connections {
        ...
        function onRecipesUpgradeOfferReady(willCreateStarterRecipe, milkPreselected) {
            ...
            if (AppInfo.previousCrashLog && AppInfo.previousCrashLog.length > 0) return

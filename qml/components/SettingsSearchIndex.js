...
function getSearchEntries(tr) {
    ...
    return [
        ...
        { tabIndex: 3, cardId: "enableServer",
          ...
          description: tr("settings.search.enableServerDesc", "HTTP server for data sharing and remote access"),
        ...
        { tabIndex: 10, cardId: "accessibility",
          ...
          description: tr("settings.search.voiceAnnouncementsDesc", "Text-to-speech during extraction"),
          keywords: ["voice", "speech", "tts", "announce", "talk"] },
        { tabIndex: 10, cardId: "accessibility",
          title: tr("settings.accessibility.frameTick", "Frame Tick Sound"),
          description: tr("settings.search.frameTickDesc", "Audio tick on extraction frame changes"),

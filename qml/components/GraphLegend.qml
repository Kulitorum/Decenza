        ...
        Repeater {
            model: [
                ...
                { label: TranslationManager.translate("graph.temp", "Temp"), sColor: Theme.temperatureColor, key: "showTemperature",
                  tip: TranslationManager.translate("graph.tip.temp", "Basket temperature in %1. The temperature at the group head thermocouple.").arg(Theme.tempUnitSuffix()) },
                { label: TranslationManager.translate("graph.mixTemp", "Mix temp"), sColor: Theme.temperatureMixColor, key: "showTemperatureMix", advanced: true,
                  tip: TranslationManager.translate("graph.tip.mixTemp", "Mix temperature in %1. The actual water temperature reaching the puck. Difference from basket temp reveals group head thermal stability.").arg(Theme.tempUnitSuffix()) },

...
QtObject {
    ...
    property color portalEcColor: _c("portalEcColor", Settings.theme.customThemeColors.portalEcColor || (isDarkMode ? "#26d7bb" : "#007d68"))
    property color portalTemperatureColor: _c("portalTemperatureColor", Settings.theme.customThemeColors.portalTemperatureColor || (isDarkMode ? "#dd83ff" : "#872cac"))

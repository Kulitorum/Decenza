...
- [x] 8.1 Full suite via the Qt Creator MCP: **113 passed, 0 failed**. The six pre-existing
...
- [ ] 8.4 Open a PR (never push to `main`), then run the automated
      `/pr-review-toolkit:review-pr` before merging.

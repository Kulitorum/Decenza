...
option is on **or** a background that requires it is active. A background image and a shot-chart
background both require it. Individual call sites SHALL NOT test the background image path, or

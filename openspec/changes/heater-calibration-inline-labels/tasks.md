...
- [ ] 3.4 Ask Jeff to load a profile with a nonzero tank_desired_water_temperature and confirm the BLE log shows the 0x80380C write with the profile's value

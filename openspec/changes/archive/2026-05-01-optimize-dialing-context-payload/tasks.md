...
- [ ] 11.2 Run the full test suite via Qt Creator MCP. — not run in this pass; this worktree isn't currently open as a Qt Creator project. Left unchecked rather than guessed.

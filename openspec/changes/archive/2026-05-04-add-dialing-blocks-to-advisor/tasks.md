...
- [x] 8.3 Live verification: send a shot analysis through the in-app advisor; capture `userPromptUsed` echo via `ai_advisor_invoke` for the same shot; confirm the JSON shapes match.

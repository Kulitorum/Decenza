...
- [ ] 4.1 Update Decenza.wiki `Manual.md` (local clone at `~/Development/GitHub/Decenza.wiki`) wherever it describes the shot detail metrics row or post-shot review field order; commit separately in the wiki repo

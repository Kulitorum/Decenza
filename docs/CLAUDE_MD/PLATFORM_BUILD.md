...
**Configure Release:**
```bash
rm -rf build/Release && mkdir -p build/Release && cd build/Release && cmake ../.. -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH="C:/Qt/6.11.0/msvc2022_64"
```
...
**Configure Debug:**
```bash
rm -rf build/Debug && mkdir -p build/Debug && cd build/Debug && cmake ../.. -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH="C:/Qt/6.11.0/msvc2022_64" -DCMAKE_BUILD_TYPE=Debug
```
...
```bash
rm -rf build/Qt_6_11_0_for_iOS && mkdir -p build/Qt_6_11_0_for_iOS && cd build/Qt_6_11_0_for_iOS && /Users/mic/Qt/6.11.0/ios/bin/qt-cmake ../.. -G Xcode
```

**Configure macOS (generates Xcode project):**
```bash
rm -rf build/Qt_6_11_0_for_macOS && mkdir -p build/Qt_6_11_0_for_macOS && cd build/Qt_6_11_0_for_macOS && /Users/mic/Qt/6.11.0/macos/bin/qt-cmake ../.. -G Xcode
```

**Open in Xcode:**
```bash
open build/Qt_6_11_0_for_iOS/Decenza.xcodeproj
# or
open build/Qt_6_11_0_for_macOS/Decenza.xcodeproj
```
...
#define QtDir "C:\Qt\6.11.0\msvc2022_64"

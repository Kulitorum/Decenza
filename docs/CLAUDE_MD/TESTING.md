...
cmake -G Ninja -DCMAKE_PREFIX_PATH=~/Qt/6.11.0/macos -DCMAKE_BUILD_TYPE=Debug ..

# Release build — tests off by default, opt-in with:
cmake -DBUILD_TESTS=ON -G Ninja -DCMAKE_PREFIX_PATH=~/Qt/6.11.0/macos -DCMAKE_BUILD_TYPE=Release ..
